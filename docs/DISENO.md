...
| UI | Panel bajo KPIs del mapa en `app_riesgo_apagon_panel.py` con simulación operativa (horizonte 15/30/45/60 min), presets de escenario, playbook de respuesta y aplicación visual de contingencia al mapa |
...
- Presets operativos (`Colapso inminente`, `Preventivo`) y cascada virtual (%) para entornos demo sin líneas.
